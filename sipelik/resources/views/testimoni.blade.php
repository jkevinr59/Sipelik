					 ...
					 <form id="testim" class="form col-md-12 center-block" action="{{URL::to('testimoniproses')}}" method="POST" enctype="multipart/form-data">
						<fieldset>
							<div class="form-group">
								<input class="form-control" placeholder="Testimoni" name="testimoni" type="textarea" autofocus="">
							</div>
							<div class="form-group">
								<input class="form-control" placeholder="Score : 0-100" name="score" type="number" value="">
							</div>
							<div class="form-group">
