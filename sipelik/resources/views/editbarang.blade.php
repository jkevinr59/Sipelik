					 ...
					 <form class="form col-md-12 center-block" action="{{URL::to('editbarangproses')}}" method="POST" enctype="multipart/form-data">
						<fieldset>
							<div class="form-group">
								<input class="form-control" placeholder="Judul Baru" name="judul" type="text" autofocus="">
							</div>
							<div class="form-group">
								<input class="form-control" placeholder="Harga Baru(/kg)" name="harga" type="text" value="">
							</div>
							<div class="form-group">
								<input class="form-control" placeholder="Deskripsi Baru" name="deskripsi" type="text" value="">
							</div>
							<div class="form-group">
